# --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
### In this file, all models (excluding the classical ratio model) for the DV other costs from the Dutch Healthcare Dataset are fitted.
...
colnames(dat_no_outliers)[colnames(dat_no_outliers)=="CostsOther"] <- "y" # Defining outcome variable
...
ggsave('Healthcare_Costsother.png', plot=last_plot(), width=10, height=5.5)
...
print(xtable(accuracy_depr, type="latex", file="Healthcare_CostsOther.tex")) # boosted models' accuracy
print(xtable(accuracy_rlm_final, type="latex", file="Healthcare_CostsOther.tex")) # non-boosted models' accuracy
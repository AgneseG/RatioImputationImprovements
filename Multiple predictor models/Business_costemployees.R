...
colnames(dat_no_outliers)[colnames(dat_no_outliers)=="Cost_personnel"] <- "y" # Defining outcome variable
...
ggsave('business_othercost.png', plot=last_plot(), width=10, height=5.5)
...
print(xtable(accuracy_depr, type="latex", file="business_Cost_personnel.tex")) # boosted models' accuracy
print(xtable(accuracy_rlm_final, type="latex", file="business_Cost_pers.tex")) # non-boosted models' accuracy
# --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
### In this file, all models (excluding the classical ratio model) for the DV total cost from the Dutch Healthcare dataset are fitted.
...
colnames(dat_no_outliers)[colnames(dat_no_outliers)=="TotalCosts"] <- "y" # Defining outcome variable
...
ggsave('Healthcare_totalcosts.png', plot=last_plot(), width=10, height=5.5)
...
print(xtable(accuracy_depr, type="latex", file="Healthcare_totalcosts.tex")) # boosted models' accuracy
print(xtable(accuracy_rlm_final, type="latex", file="Healthcare_totalcosts.tex")) # non-boosted models' accuracy
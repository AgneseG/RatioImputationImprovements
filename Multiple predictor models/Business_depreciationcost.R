# --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
### In this file, all models (excluding the classical ratio model) for the DV depreciation cost from the Dutch Structural Business are fitted.
...
colnames(dat_no_outliers)[colnames(dat_no_outliers)=="Cost_depreciations"] <- "y" # Defining outcome variable
...
ggsave('business_depreciation.png', plot=last_plot(), width=10, height=5.5)
...
print(xtable(accuracy_depr, type="latex", file="business_depreciation.tex")) # boosted models' accuracy
print(xtable(accuracy_rlm_final, type="latex", file="business_depreciation.tex")) # non-boosted models' accuracy
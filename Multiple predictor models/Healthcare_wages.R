# --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
### In this file, all models (excluding the classical ratio model) for the DV wage salaries from the Dutch Healthcare dataset are fitted.
...
colnames(dat_no_outliers)[colnames(dat_no_outliers)=="WagesSalaries"] <- "y" # Defining outcome variable
...
ggsave('Healthcare_wagesalaries.png', plot=last_plot(), width=10, height=5.5)
...
print(xtable(accuracy_depr, type="latex", file="Healthcare_wagesalaries.tex")) # boosted models' accuracy
print(xtable(accuracy_rlm_final, type="latex", file="Healthcare_wagesalaries.tex")) # non-boosted models' accuracy
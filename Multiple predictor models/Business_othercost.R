# --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
### In this file, all models (excluding the classical ratio model) for the DV OtherCost from the Dutch Structural Business are fitted.
...
colnames(dat_no_outliers)[colnames(dat_no_outliers)=="Cost_other"] <- "y" # Defining outcome variable
...
print(xtable(accuracy_depr, type="latex", file="business_Cost_personnel.tex"))
print(xtable(accuracy_rlm_final, type="latex", file="business_Cost_pers.tex"))